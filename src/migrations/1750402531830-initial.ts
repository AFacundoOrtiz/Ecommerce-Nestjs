...
export class Initial1750402531830 implements MigrationInterface {
    name = 'Initial1750402531830'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products_details_order_details" ("productsId" uuid NOT NULL, "orderDetailsId" uuid NOT NULL, CONSTRAINT "PK_c1c9617cff3c52d694c14b814c5" PRIMARY KEY ("productsId", "orderDetailsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2460e5cfa966a327dd8d9ab464" ON "products_details_order_details" ("productsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_711ee10faf19f96796177c4674" ON "products_details_order_details" ("orderDetailsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "products_details_order_details" ADD CONSTRAINT "FK_2460e5cfa966a327dd8d9ab4642" FOREIGN KEY ("productsId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "products_details_order_details" ADD CONSTRAINT "FK_711ee10faf19f96796177c46748" FOREIGN KEY ("orderDetailsId") REFERENCES "order_details"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products_details_order_details" DROP CONSTRAINT "FK_711ee10faf19f96796177c46748"`);
        await queryRunner.query(`ALTER TABLE "products_details_order_details" DROP CONSTRAINT "FK_2460e5cfa966a327dd8d9ab4642"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_711ee10faf19f96796177c4674"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2460e5cfa966a327dd8d9ab464"`);
        await queryRunner.query(`DROP TABLE "products_details_order_details"`);
